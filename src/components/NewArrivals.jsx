...
export default function NewArrivals() {
  return (
    <div id="new-arrivals" className="container mx-auto mt-30 space-y-12 z-10">
      <motion.h1
        initial={{ opacity: 0 }}
      ...
      <motion.div className="grid grid-cols-1 lg:grid-cols-3  gap-5 rounded-xl">
...
const ArrivalCompo = ({ image, title, desc, icon }) => {
  return (
    <div className="flex aspect-square bg-white rounded-2xl flex-col">
      ...
      <div className="p-6 flex items-end gap-3 justify-between border border-slate-100 border-t-0 rounded-b-xl">
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-4 mt-2 justify-between">
            ...
            <button className="bg-slate-100 p-3 rounded-full hover:bg-slate-300 transition-colors cursor-pointer">
              <ArrowUpRight />
            </button>
          </div>
        </div>
